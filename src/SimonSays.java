...
public class SimonSays extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		JOptionPane.showMessageDialog(null, "Welcome to Simon Says! Press the matching key when 'Simon says' n/ otherwise press a diffrent key!");
	...
	public void keyPressed(KeyEvent e) {
		...
		if(tries>9) {
			JOptionPane.showMessageDialog(null, "Cool job, your score is " +points+"!");
			System.exit(0);
		}
	...
	private void showImage() {
		...
		int randyNumber = randy.nextInt(2);
